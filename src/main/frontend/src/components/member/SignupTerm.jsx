	        ...
	        <div className="term-wrapper">
	            ...
	            <div className="term-content">
	                ...
	                <div className="term-section">
	                    ...
	                    <div className="term-box">
	                        (1) 사용자 정보 : 등록구분, 아이디, 패스워드, 성명, 생년월일, 성별, 전화번호, 인증구분<br/>
	                        (2) 자동차 등록 신청정보 : 차량번호, 차대번호, 성명, 생년월일, 성별, 내/외국인 구분, 전화번호, 계좌번호, 본인확인방법, 주소<br/>
	                    ...
	                    <table className="term-table">
	                        ...
	                        <tbody>
	                            <tr>
	                                ...
	                                <td>자동차등록규칙 제27조제1항 (신규등록)
									 자동차등록규칙 제29조제1항 (변경등록)
									 자동차등록규칙 제33조제1항 (이전등록)</td>
	                            </tr>
	                        </tbody>
	                    </table>
	                </div>
	                ...
	                <div className="term-section">
	                    ...
	                    <div className="term-box">
	                        자동차 등록 신청정보 : 신용카드정보(이전등록), 휴대전화번호, 비과세대상여부
	                    </div>
	                </div>
	                ...
	                <div className="term-section">
	                    ...
	                    <div className="term-box">
	                        ...
	                        (2) 자동차 등록(신규, 이전, 변경, 저당권) 민원사무 처리 : 수집∙이용에 관한 동의일로부터 1개월<br/>
	                        (3) 자동차 등록 신청
	                    </div>
	                    <table className="term-table">
	                        <thead>
