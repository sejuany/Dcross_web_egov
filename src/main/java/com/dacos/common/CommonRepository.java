...
public class CommonRepository {
     ...
     * → DTO / Map 모두 대응
     */
    public <T> T selectOne(Object param, String queryId) {
     ...
     * 다건 조회 (제네릭)
     */
    public <T> List<T> selectList(Map<String, Object> param, String queryId) {
     ...
     * 공통 단건 조회 
     */
    public <T> T commonSelectOne(Map<String, Object> params, String queryId) {
        return selectOne(params, queryId);
    }

    /**
     * 공통 리스트 조회
     */
    public <T> List<T> commonSelectList(Map<String, Object> params, String queryId) {
        return selectList(params, queryId);
    }
     ...
     * - 결과를 문자열로 변환
     */
    public String selectString(Map<String, Object> param, String queryId) {
        Object result = sqlSession.selectOne(queryId, param);
